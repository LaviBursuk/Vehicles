...
let ModalWindowComponent = class ModalWindowComponent {
    ...
    saveVehicle() {
        if (this.isValidVehicle()) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Saved!', 'The vehicle has been saved', 'success').then(() => {
...
let SearchCardComponent = class SearchCardComponent {
    ...
    filterVehicles() {
        ...
        this.mainPage.filteredVehicles = this.mainPage.AllVehicles.filter((vehicle) => ((vehicle.name === this.inputName || this.inputName === "") &&
...
let VehicleListComponent = class VehicleListComponent {
    ...
    openDialog(selectedVehicle) {
        ...
        const dialogRef = this.dialog.open(_modal_window_modal_window_component__WEBPACK_IMPORTED_MODULE_4__["ModalWindowComponent"], { data: { "selectedVehicle": selectedVehicle, "title": this.modalText } });
...
module.exports = __webpack_require__(/*! E:\Lavi\Projects\spring\Vehicles\client\src\main.ts */"./src/main.ts");
