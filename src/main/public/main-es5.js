...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
      ...
      _createClass(ModalWindowComponent, [{
        ...
        value: function saveVehicle() {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire('Saved!', 'The vehicle has been saved', 'success').then(function () {
            return _this.dialogRef.close(_this.newVehicle);
          });
        }
      }]);
    ...
    function () {
      ...
      _createClass(SearchCardComponent, [{
        ...
        value: function filterVehicles() {
          for (var i = 0; i < this.mainPage.AllVehicles.length; i++) {
            if ((this.mainPage.AllVehicles[i].name === this.inputName || this.inputName === "") && (this.mainPage.AllVehicles[i].carType === this.inputType || this.inputType === "") && (this.mainPage.AllVehicles[i].createdTime >= this.inputCreateFrom || this.inputCreateFrom === "") && (this.mainPage.AllVehicles[i].createdTime <= this.inputCreateTo || this.inputCreateTo === "") && (this.mainPage.AllVehicles[i].lastSuccessfulConnection >= this.inputLastConnectionFrom || this.inputLastConnectionFrom === "") && (this.mainPage.AllVehicles[i].lastSuccessfulConnection <= this.inputLastConnectionTo || this.inputLastConnectionTo === "")) {
        ...
        value: function refreshVehicles() {
          ...
          this.service.getAllVehicles().subscribe(function (data) {
            _this2.mainPage.AllVehicles = data;
          });
        }
      }, {
        key: "clearFilters",
      ...
      _createClass(VehicleListComponent, [{
        ...
        value: function deleteVehicle(id) {
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_7___default.a.fire({
            ...
            if (result.value) {
              _this4.service.deleteVehicle(id).subscribe(function (data) {
                _this4.refreshVehicles();

                if (_this4.mainPage.AllVehicles.length === 1) {
                  _this4.showPlaceHolder = false;
                }
              });
          ...
          dialogRef.afterClosed().subscribe(function (result) {
            if (result !== undefined) {
              ...
              if (result.id == undefined) {
                ...
                _this5.service.addVehicle(result).subscribe(function (data) {
                  _this5.refreshVehicles();

                  if (_this5.mainPage.AllVehicles.length === 0) {
                    _this5.showPlaceHolder = true;
                  }
                });
              } else {
                _this5.service.updateVehicle(result).subscribe(function (data) {
                  return _this5.refreshVehicles();
                });
              }
            }
          });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! E:\Lavi\Projects\spring\Vehicles\src\main\resources\client\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
